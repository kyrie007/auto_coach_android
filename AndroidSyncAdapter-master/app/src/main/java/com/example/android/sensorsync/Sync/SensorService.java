...
//    private TextView ms1,ms2,ms3,ms4,ms5,ms6;
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        if (sensor.getType() == Sensor.TYPE_ACCELEROMETER) {
            ...
            value.put(SensorContract.SensorEntry.COLUMN_ACC_X, Math.round(event.values[0]));
            ...
            MainActivity.getMainActivity().setText(1,(Math.round(event.values[0] * 100)));
            MainActivity.getMainActivity().setText(2,(Math.round(event.values[1] * 100)));
            MainActivity.getMainActivity().setText(3,(Math.round(event.values[2] * 100)));
