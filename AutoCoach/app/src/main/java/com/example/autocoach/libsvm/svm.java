...
import com.example.autocoach.libsvm.svm_problem;
...
class SVC_Q extends Kernel
{
	...
	SVC_Q(com.example.autocoach.libsvm.svm_problem prob, svm_parameter param, byte[] y_)
	{
...
class ONE_CLASS_Q extends Kernel
{
	...
	ONE_CLASS_Q(com.example.autocoach.libsvm.svm_problem prob, svm_parameter param)
	{
		super(prob.l, prob.x, param);
		cache = new Cache(prob.l,(long)(param.cache_size*(1<<20)));
		QD = new double[prob.l];
...
class SVR_Q extends Kernel
{
	...
	SVR_Q(com.example.autocoach.libsvm.svm_problem prob, svm_parameter param)
	{
		super(prob.l, prob.x, param);
		l = prob.l;
...
public class svm {
	...
	private static void solve_c_svc(com.example.autocoach.libsvm.svm_problem prob, svm_parameter param,
	...
	private static void solve_nu_svc(com.example.autocoach.libsvm.svm_problem prob, svm_parameter param,
                                     double[] alpha, Solver.SolutionInfo si)
	{
		int i;
		int l = prob.l;
	...
	private static void solve_one_class(com.example.autocoach.libsvm.svm_problem prob, svm_parameter param,
                                        double[] alpha, Solver.SolutionInfo si)
	{
		int l = prob.l;
		double[] zeros = new double[l];
	...
	private static void solve_epsilon_svr(com.example.autocoach.libsvm.svm_problem prob, svm_parameter param,
                                          double[] alpha, Solver.SolutionInfo si)
	{
		int l = prob.l;
	...
	private static void solve_nu_svr(com.example.autocoach.libsvm.svm_problem prob, svm_parameter param,
                                     double[] alpha, Solver.SolutionInfo si)
	{
		int l = prob.l;
		double C = param.C;
	...
	static decision_function svm_train_one(
			com.example.autocoach.libsvm.svm_problem prob, svm_parameter param,
            double Cp, double Cn)
	{
	...
	private static void svm_binary_svc_probability(com.example.autocoach.libsvm.svm_problem prob, svm_parameter param, double Cp, double Cn, double[] probAB)
	{
		int i;
		int nr_fold = 5;
		...
		for(i=0;i<nr_fold;i++)
		{
			...
			int j,k;
			com.example.autocoach.libsvm.svm_problem subprob = new com.example.autocoach.libsvm.svm_problem();
	...
	private static double svm_svr_probability(com.example.autocoach.libsvm.svm_problem prob, svm_parameter param)
	{
		int i;
		int nr_fold = 5;
	...
	private static void svm_group_classes(com.example.autocoach.libsvm.svm_problem prob, int[] nr_class_ret, int[][] label_ret, int[][] start_ret, int[][] count_ret, int[] perm)
	{
		int l = prob.l;
		int max_nr_class = 16;
		int nr_class = 0;
	...
	// Interface functions
	//
	public static svm_model svm_train(com.example.autocoach.libsvm.svm_problem prob, svm_parameter param)
	{
		...
		else
		{
			...
			for(i=0;i<nr_class;i++)
				...
				{
					com.example.autocoach.libsvm.svm_problem sub_prob = new com.example.autocoach.libsvm.svm_problem();
	...
	public static void svm_cross_validation(com.example.autocoach.libsvm.svm_problem prob, svm_parameter param, int nr_fold, double[] target)
	{
		int i;
